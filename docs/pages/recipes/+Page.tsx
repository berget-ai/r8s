...
export default function Page() {
  ...
  config({
    ...
    description:
      'Production-ready Kubernetes infrastructure recipes and boilerplates. PostgreSQL, web services, ingress, and complete application templates.',
  })
    ...
    <div className="space-y-8">
      ...
      <div className="prose prose-invert max-w-none">
        <p className="text-base leading-relaxed">
          Browse our collection of infrastructure recipes. Each recipe is a tested, production-ready
          template that you can copy and customize for your needs.
        </p>
      </div>
      ...
      <div className="grid gap-6">
        {recipes.map((recipe) => (
          ...
          >
            ...
            <p className="text-cloud/70 text-sm leading-relaxed mb-4">{recipe.description}</p>
      ...
      <div className="mt-12 p-6 rounded-lg border border-white/10 bg-spruce/20">
        ...
        <p className="text-cloud/70 text-sm leading-relaxed">
          These recipes are built with r8s components. You can combine them, customize them, or
          create your own. Check out the{' '}
