...
export const searchEntries: SearchEntry[] = [
  {
    title: 'Overview',
    description:
      'r8s — Kubernetes manifests as TSX components. Stop writing YAML, start composing infrastructure.',
    href: '/',
    category: 'Pages',
  ...
  },
  {
    title: 'Core Concepts',
    description:
      'JSX factory, function components, context system, and type safety for Kubernetes resources.',
    href: '/core',
    category: 'Pages',
  ...
  },
  {
    title: 'Recipes',
    description:
      'Browse all pre-built infrastructure recipes — Database, WebService, App, Ingress, Cluster.',
    href: '/recipes',
    category: 'Pages',
  ...
  },
  {
    ...
    description:
      'How r8s tracks Kubernetes operator dependencies explicitly, type-safely, and version-pinned.',
    href: '/operators',
    category: 'Pages',
  ...
  },
  {
    title: 'Packages',
    description:
      'Browse all operator-backed infrastructure packages — cert-manager, OpenBao, Keycloak, ExternalDNS, Redis, Gateway, Monitoring, ClickHouse, Logging, Loki.',
    href: '/packages',
    category: 'Pages',
  ...
  },
  {
    title: 'Testing',
    description:
      'Test r8s components with Vitest. Write guardrails that verify infrastructure meets policy.',
    href: '/testing',
    category: 'Pages',
  ...
  },
  {
    title: 'Database',
    description:
      'Production-ready PostgreSQL cluster using CloudNativePG operator. HA, backups, monitoring.',
  ...
  },
  {
    title: 'Web Service',
    description:
      'Deployment + Service with health checks and resource limits. Production web service boilerplate.',
  ...
  },
  {
    title: 'App',
    description:
      'Complete application template: database, web service, ingress, and TLS. The fastest way to ship.',
    href: '/recipes/app',
    category: 'Recipes',
    keywords: [
      'app',
  ...
  },
  {
    title: 'Ingress',
    description:
      "Ingress with automatic TLS via cert-manager. nginx-ingress and Let's Encrypt integration.",
  ...
  },
  {
    title: 'Cluster',
    description:
      'Shared PostgreSQL cluster for multiple databases. Reduce resources by sharing one CNPG cluster.',
  ...
  },
  {
    title: '@r8s/core',
    description:
      'JSX factory + all Kubernetes API components (<deployment>, <service>, <ingress>, etc.).',
    href: '/core',
    category: 'Components',
    keywords: [
      'core',
  ...
  },
  {
    title: '@r8s/recipes',
    description:
      'Pre-built components: <App>, <Database>, <Ingress>, <WebService>, <Cluster>. cnpg + nginx-ingress.',
    href: '/recipes',
    category: 'Components',
    keywords: [
      'recipes',
  ...
  },
  {
    title: '@r8s/openbao',
    description:
      'Secret management components powered by OpenBao. Declares vault-secrets-operator.',
  ...
  },
  {
    ...
    description:
      'In-cluster TSX rendering controller for FluxCD integration. Render TSX in the cluster.',
    href: '/deployment',
    category: 'Components',
    keywords: [
      'r8s-controller',
